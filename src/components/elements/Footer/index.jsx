...
const Footer = () => {
  return (
    <footer className='flex flex-col py-20'>
      <div className='grid md:grid-cols-4 px-6 md:px-10 gap-10 md:gap-4'>
        <div className='flex flex-col gap-4'>
          <h4 className='font-bold md:text-base lg:text-xl'>WeSafe.</h4>
          <p className='text-black text-sm lg:text-base text-opacity-80'>We offers a high-level security systems to protect your valuable assets. We have the best services to meet your needs.</p>
